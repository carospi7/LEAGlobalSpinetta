...
//             //suma el id al nivel de las otras propiedades del producto
//             return { id: doc.id, ...doc.data() }
//         })
//         return products
//     }) // ytaer los documentos que estan en la conexion items de la db
// }
// // export const getItems = () => {
...
//     return new Promise((resolve, reject) => {
//         setTimeout(() => resolve(object[0]), 1000)
//     })
// }
...
//     return new Promise((resolve) => {
//         const item = object.filter( product => product.category === category)
//         setTimeout(() => resolve(item), 1000)
//     })
// }